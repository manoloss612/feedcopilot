...
from feedcopilot.rss.fetcher import fetch_enabled_feeds, normalize_items, parse_feed_content
...
def test_fetch_enabled_feeds_stores_new_items(tmp_path, monkeypatch):
    ...
    def fake_fetch_feed(url, timeout=20, user_agent="FeedCopilot/0.1"):
